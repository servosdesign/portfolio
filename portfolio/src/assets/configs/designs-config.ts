  ...
  leftAligned: [
    {
      ...
      imageSrc: '../src/assets/images/codecrecordings.png',
      title: 'CODEC RECORDINGS',
      description: 'Codec Recordings is a record label based in Dallas Texas run by Techno producer Decoder. In 2020, when the label was just getting started, I was contacted to make artwork for a compilation album. These prints were provided for their first compilation album which helped them gather recognition and become the label they are today. Please click on the button to view their soundcloud page and listen to their work.',
  ...
  rightAligned: [
    {
      ...
      imageSrc: '../src/assets/images/methuselahrecords.png',
